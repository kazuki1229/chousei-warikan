// This is a modified version of the shadcn calendar component
// to support Japanese locale and calendar features needed for our app
      ...
      components={{
        Dropdown: ({ value, onChange, children, ...props }: DropdownProps) => {
          ...
          return (
            ...
            >
              <SelectTrigger className="h-7 text-xs border-none p-1 px-2 font-normal bg-transparent data-[placeholder]:text-slate-900">
